...
param['couronne'] = str(param['dist_min']) + '-' + str(param['dist_max'])
...
param['angle_max'] = float(input('angle_max (sens horaire) [angle_min -> 360]: '))
param['angle'] = str(param['angle_min']) + '-' + str(param['angle_max'])
...
with open('parametres.txt', 'w') as my_ext:
    ...
    my_ext.write('fault strike: ' + str(param['strike']) + ' deg\n')
