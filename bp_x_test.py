...
lst_pth_dt = path + '/' + dossier + '_vel'
lst_pth_rslt = lst_pth_dt + '_results'
if os.path.isdir(lst_pth_rslt) == False:
    os.makedirs(lst_pth_rslt)

lst_fch = os.listdir(lst_pth_dt)
lst_fch = [a for a in lst_fch if ('NS' in a) == True]
print(lst_fch)
...
os.chdir(lst_pth_rslt)
with open('stack_vel_env', 'wb') as my_fch_stk:
