...
for freq in lst_frq:
    lst_pth_dt.append(path + '/' + dossier + '_vel_' + freq + 'Hz/' + dossier + '_vel_' + freq + 'Hz_hori_env_smooth')
...
for freq in lst_frq:
    ...
    lst_pth_rslt_P.append(pth_dt + '_hori_env_smooth_P')
    lst_pth_rslt_S.append(pth_dt + '_hori_env_smooth_S')
