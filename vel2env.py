...
for freq in lst_frq:
    lst_pth_dt[lst_frq.index(freq)] = path + '/' + dossier + '_vel_' + freq + 'Hz_3comp'
    lst_pth_rslt[lst_frq.index(freq)] = path + '/' +dossier + '_vel_' + freq + 'Hz_3comp_env'
...
for pth in lst_pth_dt:
    lst_fch[lst_pth_dt.index(pth)] = os.listdir(pth)
